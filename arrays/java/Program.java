...
The intervals could be ordered differentlv. */
...
public class Program {
  public int[][] mergeOverlappingIntervals(int[][] intervals) {
    ...
    for (int i = 1; i < intervals.length; i++) {
       ...
       * previousInterval. We dont add it right the way to the result as we need to
      ...
      /*
       * if it's the last element of the the interval Array , then we don't have
